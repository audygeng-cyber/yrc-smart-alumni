...
export const memberPortalPayload = {
  ...
  financeCards: [
    { label: 'งานบัญชีในแอป', value: '—', hint: 'โมดูลบัญชีถูกถอดออก — ดูสถิติกิจกรรมโรงเรียนจากการ์ดกองยุพราชด้านล่าง' },
    { label: 'กิจกรรมโรงเรียน', value: 'สถิติ', hint: 'school_activities + ยอดบริจาคตามกิจกรรม (เมื่อมีข้อมูล)' },
    { label: 'รายงานการเงิน', value: '—', hint: 'ไม่เผยแพร่ผ่านพอร์ทัลสมาชิกในรุ่นนี้' },
    { label: 'ประชุม/วาระ', value: '—', hint: 'พอร์ทัลคณะกรรมการ /committee/meetings' },
  ],
  meetingReports: [
