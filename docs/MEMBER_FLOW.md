...
2. **ตรวจสอบและผูก** — เลือก **รุ่น** จากรายการในฐานข้อมูล (API `GET /api/members/registry-batches`) และกรอก **ชื่อ · นามสกุล** ให้ตรงแถวที่ Admin นำเข้า  
...
|--------|------|-----------|
| GET | `/api/members/registry-batches` | คืน `{ "ok": true, "batches": ["2520", ...] }` — รุ่นไม่ซ้ำจาก `members` (dropdown หน้าผูก LINE) |
