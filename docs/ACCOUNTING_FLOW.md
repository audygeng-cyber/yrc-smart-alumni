...
**ความต้องการเจ้าของผลิตภัณฑ์ (สรุปขอบเขต):** โฟกัสที่ระบบงานบัญชีที่ใช้งานได้ครบในกรอบโปรเจกต์ และ **ส่งออก Excel ให้ผู้ตรวจสอบนำไปปิดงบการเงินนอกระบบ** — **ไม่** กำหนดให้ YRC เป็นผู้ปิดงบการเงินแทนผู้ตรวจ — รายละเอียดบันทึกถาวรใน [`ACCOUNTING_OWNER_REQUIREMENTS.md`](./ACCOUNTING_OWNER_REQUIREMENTS.md)
...
**ขอบเขตผลิตภัณฑ์:** ระบบนี้เน้นระดับ **ผู้ใช้บันทึกและส่งออกข้อมูล** รายละเอียดที่บันทึกได้ควร **ส่งออกเป็น Excel/CSV** (รวมชุดส่งผู้ตรวจ) เพื่อให้ **ผู้ตรวจสอบบัญชีภายนอก** นำไป **ปิดงบการเงินตามกฎหมาย/มาตรฐานวิชาชีพ** ในเครื่องมือของผู้ตรวจเอง — **ไม่ได้ออกแบบให้ระบบนี้แทนขั้นตอนปิดงบฯ ครบวงจรในระดับผู้สอบบัญชี** โดยตรง (ดูนิยามและข้อยกเว้นใน [`ACCOUNTING_OWNER_REQUIREMENTS.md`](./ACCOUNTING_OWNER_REQUIREMENTS.md))
