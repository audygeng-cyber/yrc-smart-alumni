...
- **Master Guidelines (เทียบ stack + ช่องว่าง):** [`docs/PROJECT_MASTER_GUIDELINES.md`](docs/PROJECT_MASTER_GUIDELINES.md)
- **Runbook การใช้งานหลัก (ต้นจนจบ):** [`docs/OPERATIONAL_RUNBOOK.md`](docs/OPERATIONAL_RUNBOOK.md) — มีหัวข้อ **นักพัฒนา** (สโมกรายชั่วโมง, ความปลอดภัย, ทำงานต่อหลังจบงานย่อย) สอดคล้อง [`.cursorrules`](.cursorrules) §7
...
โมดูลบัญชี/การเงินถูกถอดออกจากรีโปแล้ว — โฟกัสผู้ดูแลอยู่ที่กิจกรรมโรงเรียนและสถิติ (`/admin/school-activities`; API `GET /api/admin/school-activities/donations/summary` ฯลฯ)
