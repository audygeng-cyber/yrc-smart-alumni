          ...
          <div className="min-w-0">
            ...
            {props.restoringMemberSession ? (
              ...
              <p className="mt-1 text-amber-200">
                มี LINE UID แล้ว แต่ยังไม่ได้ผูกสมาชิกในรอบนี้ — เลือกรุ่นจากทะเบียน · กรอกชื่อ · นามสกุล ให้ตรง แล้วกด &quot;ตรวจสอบและผูก&quot;
              </p>
            ) : (
              <p className="mt-1 text-slate-400">
                ยังไม่มี LINE เซสชัน หรือเซสชันสมาชิก — เลือกรุ่น · กรอกชื่อ · นามสกุล แล้วกดเข้าสู่ระบบ LINE ด้านล่างฟอร์ม
              </p>
            )}
          </div>
          {hasMember ? (
